// Package idbatcher is copied from "github.com/open-telemetry/opentelemetry-collector-contrib/processor/tailsamplingprocessor/internal/idbatcher"
package idbatcher
...
// and a new batch being built outside the pipe. Items can be concurrently added to the batch
